// This file was scaffolded via ui.bazza.dev (shadcn/ui recipe: https://ui.bazza.dev/r/filters)
// It contains utility functions used by the DataTableFilter component.
// Biome linting rules are ignored in the config file

import type { AccessorFn, Column, ColumnMeta, Row, RowData, Table } from "@tanstack/react-table";
